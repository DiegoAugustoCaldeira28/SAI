...
public class AlunoController implements Serializable {
    ...
    private ArrayList<Matricula> duplicados = new ArrayList<>();
     ...
     */
    public ArrayList<Matricula> getDuplicados() {
        return duplicados;
    }
     ...
     */
    public void setDuplicados(ArrayList<Matricula> duplicados) {
    ...
    public void verificarDuplicados() {
        ...
        aluno = ejbFacade.findAll();
        int flag = 0;
        for (Aluno aluno1 : aluno) {
            matricula = matriculaFacade.findByAluno(aluno1);
            for (Matricula matricula1 : matricula) {
                for (Matricula matricula2 : matricula) {
                    if (matricula1.getIdevento().getIdevento().equals(matricula2.getIdevento().getIdevento())) {
                        flag++;
                        if (flag == 2) {
                            System.out.println("Entrou: " + matricula1 + "2:" + matricula2);
                            duplicados.add(matricula2);
                            break;
                        }
                    }
                }
            ...
            for (Matricula matricula1 : matricula) {
                for (Matricula matricula2 : matricula) {
                    if (matricula1.getIdevento().getIdevento().equals(matricula2.getIdevento().getIdevento())) {
                        ...
                        if (flag >= 2) {
                            System.out.println("Entrou: " + matricula1 + "2:" + matricula2);
                            if(!matricula2.getPago()){
                                matriculaFacade.remove(matricula2);
                            }else if(!matricula1.getPago()){
                                matriculaFacade.remove(matricula1);
                            }else{
                                matriculaFacade.remove(matricula2);
                            }                            
                            break;
