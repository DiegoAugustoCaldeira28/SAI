...
@NamedQueries({
    ...
    , @NamedQuery(name = "Historico.findallEventos", query = "SELECT h FROM Historico h GROUP BY h.idevento")
    , @NamedQuery(name = "Historico.verificaEvento", query = "SELECT h FROM Historico h where h.idevento = :idevento")})
